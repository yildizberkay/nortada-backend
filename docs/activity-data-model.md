...
**`activity`** (kimlik + statü; yanlış sınıflandırılan `sport` kullanıcı tarafından düzeltilebilir)
...
- işaretler: `markers` (double[]; Mark tuşunun saniye offset'leri, sıralı — P0'da tasarımdaki L1 `activity_event.user_marker`'ın **bilinçli basitleştirmesi**; event tablosu gelirse buradan türetilir, ikisi birden yaşamaz; 2026-07-20)
